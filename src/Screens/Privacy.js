...
export const PrivacyPolicy = () => {
  return (
    <>
      <div style={{ paddingVertical: "50px", maxWidth: "600px", margin: "auto" }}>
    ...
    <strong>
      <span style={{ fontSize: "15px" }}>
        <span data-custom-class="subtitle">
          Last updated 
          <bdt class="question">September 16, 2022</bdt>
        </span>
      </span>
    </strong>
  </span>
  ...
  <span style={{ color: "rgb(127, 127, 127)" }}>
    <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
      <span data-custom-class="body_text">
        ...
        <bdt class="question">Sorcery Limited</bdt>
    ...
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
      <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
        <span data-custom-class="body_text">
          ...
          <bdt class="block-component"></bdt>
          at 
          <bdt class="question"><a href="http://www.nomoresocks.app" target="_blank" data-custom-class="link">http://www.nomoresocks.app</a></bdt>
          <span style={{ fontSize: "15px" }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: "15px" }}>
  ...
  <span style={{ fontSize: "15px" }}>
    <span style={{ color: "rgb(127, 127, 127)" }}>
      <span data-custom-class="body_text">
        ...
        <bdt class="question">mark@sorcery-ltd.co.uk</bdt>
        .
      </span>
    </span>
  </span>
...
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px" }}>
    <a data-custom-class="link" href="#legalbases">
      <span style={{ color: "rgb(89, 89, 89)" }}>
        3. <span style={{ fontSize: "15px" }}><span style={{ color: "rgb(89, 89, 89)" }}>WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</span></span>
        <bdt class="statement-end-if-in-editor"></bdt>
      </span>
    </a>
  </span>
...
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px" }}>
    <a data-custom-class="link" href="#inforetain"><span style={{ color: "rgb(89, 89, 89)" }}>5. HOW LONG DO WE KEEP YOUR INFORMATION?</span></a>
    <span style={{ color: "rgb(127, 127, 127)" }}>
      <span style={{ color: "rgb(89, 89, 89)" }}>
        <span data-custom-class="body_text">
          <span style={{ color: "rgb(89, 89, 89)" }}>
...
<div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px" }}><span style={{ color: "rgb(89, 89, 89)" }}><a data-custom-class="link" href="#privacyrights">7. WHAT ARE YOUR PRIVACY RIGHTS?</a></span></span></div>
<div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px" }}><a data-custom-class="link" href="#DNT"><span style={{ color: "rgb(89, 89, 89)" }}>8. CONTROLS FOR DO-NOT-TRACK FEATURES</span></a></span></div>
<div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px" }}><a data-custom-class="link" href="#caresidents"><span style={{ color: "rgb(89, 89, 89)" }}>9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span></a></span></div>
<div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px" }}><a data-custom-class="link" href="#policyupdates"><span style={{ color: "rgb(89, 89, 89)" }}>10. DO WE MAKE UPDATES TO THIS NOTICE?</span></a></span></div>
<div style={{ lineHeight: 1.5 }}><a data-custom-class="link" href="#contact"><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></a></div>
<div style={{ lineHeight: 1.5 }}><a data-custom-class="link" href="#request"><span style={{ color: "rgb(89, 89, 89)" }}>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span></a></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
...
<ul>
  <li style={{ lineHeight: 1.5 }}>
    <span data-custom-class="body_text"><span style={{ fontSize: "15px" }}><strong>To save or protect an individual's vital interest.</strong> We may process your information when necessary to save or protect an individual’s vital interest, such as to prevent harm.</span></span>
    <bdt class="statement-end-if-in-editor"><span style={{ fontSize: "15px" }}><span data-custom-class="body_text"></span></span></bdt>
  </li>
</ul>
<div style={{ lineHeight: 1.5 }}><br/></div>
...
<ul>
  <li style={{ lineHeight: 1.5 }}>
    ...
    <a data-custom-class="link" href="#withdrawconsent"><span style={{ fontSize: "15px" }}><span data-custom-class="body_text">here</span></span></a><span style={{ fontSize: "15px" }}><span data-custom-class="body_text"> to learn more.</span></span>
  </li>
</ul>
<div style={{ lineHeight: 1.5 }}>
  <bdt class="block-component"><span style={{ fontSize: "15px" }}><span data-custom-class="body_text"></span></span></bdt>
</div>
<ul>
  <li style={{ lineHeight: 1.5 }}>
    <span data-custom-class="body_text">
...
<div style={{ lineHeight: 1.5 }}>
  ...
  <a data-custom-class="link" href="#withdrawconsent"><span data-custom-class="body_text"><span style={{ fontSize: "15px" }}>here</span></span></a><span data-custom-class="body_text"><span style={{ fontSize: "15px" }}> to learn more.</span></span>
</div>
<div style={{ lineHeight: 1.5 }}><br/></div>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div id="inforetain" style={{ lineHeight: 1.5 }}><span style={{ color: "rgb(127, 127, 127)" }}><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span id="control" style={{ color: "rgb(0, 0, 0)" }}><strong><span data-custom-class="heading_1">5. HOW LONG DO WE KEEP YOUR INFORMATION?</span></strong></span></span></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div id="infosafe" style={{ lineHeight: 1.5 }}><span style={{ color: "rgb(127, 127, 127)" }}><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span id="control" style={{ color: "rgb(0, 0, 0)" }}><strong><span data-custom-class="heading_1">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</span></strong></span></span></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div id="privacyrights" style={{ lineHeight: 1.5 }}><span style={{ color: "rgb(127, 127, 127)" }}><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span id="control" style={{ color: "rgb(0, 0, 0)" }}><strong><span data-custom-class="heading_1">7. WHAT ARE YOUR PRIVACY RIGHTS?</span></strong></span></span></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div id="DNT" style={{ lineHeight: 1.5 }}><span style={{ color: "rgb(127, 127, 127)" }}><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span id="control" style={{ color: "rgb(0, 0, 0)" }}><strong><span data-custom-class="heading_1">8. CONTROLS FOR DO-NOT-TRACK FEATURES</span></strong></span></span></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div id="caresidents" style={{ lineHeight: 1.5 }}><span style={{ color: "rgb(127, 127, 127)" }}><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span id="control" style={{ color: "rgb(0, 0, 0)" }}><strong><span data-custom-class="heading_1">9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span></strong></span></span></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}><span data-custom-class="heading_2" style={{ color: "rgb(0, 0, 0)" }}><span style={{ fontSize: "15px" }}><strong>CCPA Privacy Notice</strong></span></span></div>
<div>
  <div><br/></div>
  <div style={{ lineHeight: 1.5 }}>
    <span style={{ color: "rgb(127, 127, 127)" }}>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5, marginLeft: "20px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">(1) every individual who is in the State of California for other than a temporary or transitory purpose and</span></span></span></div>
<div style={{ lineHeight: 1.5, marginLeft: "20px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">(2) every individual who is domiciled in the State of California who is outside the State of California for a temporary or transitory purpose</span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
...
<table style={{ width: "100%" }}>
  <tbody>
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><strong>Category</strong></span></span></span></td>
      ...
      <td style={{ width: "14.9084%", borderRight: "1px solid black", borderTop: "1px solid black", textAlign: "center" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><strong>Collected</strong></span></span></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">B. Personal information categories listed in the California Customer Records statute</span></span></span></div>
      </td>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">C. Protected classification characteristics under California or federal law</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">D. Commercial information</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">E. Biometric information</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">F. Internet or other similar network activity</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}>
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">G. Geolocation data</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">Device location</span></span></span></div>
      </td>
      <td style={{ width: "14.9084%", textAlign: "center", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><br/></div>
        <div style={{ lineHeight: 1.5 }}>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">H. Audio, electronic, visual, thermal, olfactory, or similar information</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">Images and audio, video or call recordings created in connection with our business activities</span></span></span></div>
      </td>
      <td style={{ width: "14.9084%", textAlign: "center", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><br/></div>
        <div style={{ lineHeight: 1.5 }}>
    ...
    <tr>
      <td style={{ width: "33.8274%", borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">I. Professional or employment-related information</span></span></span></div>
      </td>
      <td style={{ width: "51.4385%", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</span></span></span></div>
      </td>
      <td style={{ width: "14.9084%", textAlign: "center", borderRight: "1px solid black", borderTop: "1px solid black" }}>
        <div style={{ lineHeight: 1.5 }}><br/></div>
        <div style={{ lineHeight: 1.5 }}>
    ...
    <tr>
      <td style={{ borderLeft: "1px solid black", borderRight: "1px solid black", borderTop: "1px solid black", width: "33.8274%" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">J. Education Information</span></span></span></div>
      </td>
      <td style={{ borderRight: "1px solid black", borderTop: "1px solid black", width: "51.4385%" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">Student records and directory information</span></span></span></div>
      </td>
    ...
    <tr>
      <td style={{ borderWidth: "1px", borderColor: "black", borderStyle: "solid", width: "33.8274%" }}>
        <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">K. Inferences drawn from other personal information</span></span></span></div>
      </td>
...
<div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><strong>How do we use and share your personal information?</strong></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
  ...
  <div style={{ lineHeight: 1.5 }}>
    ...
    <span>or by referring to the contact details at the bottom of this document.</span>
  </div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
  ...
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Each service provider is a for-profit entity that processes the information on our behalf.</span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
      <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
  ...
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><strong>Your rights with respect to your personal data</strong></span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><u>Right to request deletion of the data — Request to delete</u></span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">You can ask for the deletion of your personal information. If you ask us to delete your personal information, we will respect your request and delete your personal information, subject to certain exceptions provided by law, such as (but not limited to) the exercise by another consumer of his or her right to free speech, our compliance requirements resulting from a legal obligation, or any processing that may be required to protect against illegal activities.</span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><u>Right to be informed — Request to know</u></span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
      <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
  ...
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">In accordance with applicable law, we are not obligated to provide or delete consumer information that is de-identified in response to a consumer request or to re-identify individual data to verify a consumer request.</span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><u>Right to Non-Discrimination for the Exercise of a Consumer’s Privacy Rights</u></span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text">We will not discriminate against you if you exercise your privacy rights.</span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><u>Verification process</u></span></span></span></div>
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
      <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
  ...
  <div style={{ lineHeight: 1.5 }}><br/></div>
  <div style={{ lineHeight: 1.5 }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span data-custom-class="body_text"><u>Other privacy rights</u></span></span></span></div>
  <div>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
      <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
        <span data-custom-class="body_text">
      ...
      <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
        <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
          <span data-custom-class="body_text">
            ...
            authorised
            <bdt class="else-block"></bdt>
            agent to make a request under the CCPA on your behalf. We may deny a request from an 
            <bdt class="block-component"></bdt>
            authorised
            <bdt class="else-block"></bdt>
...
<div style={{ lineHeight: 1.5 }}><br/></div>
<div id="contact" style={{ lineHeight: 1.5 }}><span style={{ color: "rgb(127, 127, 127)" }}><span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}><span id="control" style={{ color: "rgb(0, 0, 0)" }}><strong><span data-custom-class="heading_1">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></strong></span></span></span></span></span></div>
<div style={{ lineHeight: 1.5 }}><br/></div>
<div style={{ lineHeight: 1.5 }}>
  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
    <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
      <span data-custom-class="body_text">
        ...
        <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
          <span data-custom-class="body_text">
            <bdt class="question">Mark Peter Wilcox</bdt>
          </span>
        </span>
        ,
        <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            ...
            <span data-custom-class="body_text"> by email at </span>
          </span>
        </span>
        <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
          <span data-custom-class="body_text">
...
<div style={{ lineHeight: 1.5 }}>
  <span data-custom-class="body_text">
    <bdt class="question">York</bdt>
    <span style={{ fontSize: "15px" }}>
      <span data-custom-class="body_text">
        <bdt class="block-component"></bdt>
        , 
        <bdt class="question"> North Yorkshire,</bdt>
        <bdt class="statement-end-if-in-editor"></bdt>
      </span>
      <bdt class="block-component"></bdt>
      <bdt class="question"> YO24 1JJ</bdt>
      <bdt class="statement-end-if-in-editor"></bdt>
      <span data-custom-class="body_text">
        <span style={{ color: "rgb(89, 89, 89)" }}>
          <bdt class="block-component"></bdt>
...
<div style={{ lineHeight: 1.5 }}>
  ...
  <div style={{ lineHeight: 1.5 }}>
    <span data-custom-class="body_text" style={{ fontSize: "15px" }}>
      If you are a resident in the United Kingdom, the 
      <bdt class="block-component"></bdt>
      'data controller'
      <bdt class="else-block"></bdt>
      ...
      to be its representative in the UK. You can contact them directly regarding the processing of your information by 
      <bdt class="question">Sorcery Limited</bdt>
      <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
        <span data-custom-class="body_text">
          ,
